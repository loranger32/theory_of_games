...
class BehaviorClassMethodsTest < Minitest::Test
  ...
  def test_choose_random_move
    assert_includes [:cooperates, :betrays], Behavior.choose_random_move
  end
end
